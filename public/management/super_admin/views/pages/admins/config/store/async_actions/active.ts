...
const fetch_api = async (param, thunkAPI) => {
    ...
    dispatch(storeSlice.actions.set_loading_text('activing..'));

    const response = await axios.post(
        `${end_point}/${api_prefix}/active`,
        { id: param.id },
    );
    ...
    (window as anyObject).toaster('data activated.');
