                                            ...
                                            <div className="row g-3">
                                                ...
                                                <div className="col-12">
                                                    <div className="row g-3">
                                                        ...
                                                        <div className="col-12 col-md-6 col-lg-6">
                                                            <div className="form-group form-vertical">
                                                                <label className="form-label">Branch Class Building</label>
                                                                <BranchClassBuildingsDropDown
                                                                    name="branch_class_building_id"
                                                                    multiple={false}
                                                                    default_value={
                                                                        getValueForEdit(state, 'branch_class_building_id')
                                                                            ? [
                                                                                {
                                                                                    id: getValueForEdit(state, 'branch_class_building_id'),
                                                                                },
                                                                            ]
                                                                            : []
                                                                    }
                                                                    ...
                                                                    isFocused={focusedDropdown["branch_class_building_id"]}
                                                                    onFocus={() => setFocusedDropdown({ branch_class_building_id: true })}
                                                                    onBlur={() => setFocusedDropdown({ branch_class_building_id: false })}
                                                                />
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="col-12">
                                                    <div className="row g-3">
                                                        ...
                                                        <div className="col-12 col-md-6 col-lg-6">
                                                            <div className="form-group form-vertical">
                                                                <Input name="code" value={getValueForEdit(state, 'code')} />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="col-12 col-md-6 col-lg-6">
                                                            <div className="form-group form-vertical">
                                                                <Input
                                                                    name="capacity"
                                                                    type="number"
                                                                    value={getValueForEdit(state, 'capacity')}
                                                                    min={1}
                                                                />
                                                            </div>
                                                        </div>
