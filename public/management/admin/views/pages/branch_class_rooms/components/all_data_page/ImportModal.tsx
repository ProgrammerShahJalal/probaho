...
const ImportModal: React.FC<ImportUsersModalProps> = ({ isOpen, onClose }) => {
    ...
    const handleDownloadDemo = () => {
        ...
        const sampleRow = [
            ...
            '2', // branch_class_building_id (example building ID)
            'Room 202', // title 
            'R202', // code
            '100', // capacity
        ...
        new CsvBuilder('demo_branch_class_rooms_import_template.csv')
            .setColumns(columns)
            ...
            <div className="modal-dialog modal-dialog-centered" role="document" onClick={e => e.stopPropagation()}>
                <div className="modal-content" style={{ background: '#23272f', color: '#fff', borderRadius: 10, boxShadow: '0 8px 32px rgba(0,0,0,0.25)' }}>
                    <div className="modal-header">
                        <h5 className="modal-title" style={{ fontSize: '1.1rem' }}>Import Branch Class Rooms</h5>
