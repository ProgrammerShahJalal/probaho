    ...
    useEffect(() => {
        ...
        dispatch(
            storeSlice.actions.set_select_fields(
                'id,branch_user_id,branch_id,academic_year_id,academic_calendar_event_types_id,event_name,description,date,status',
            ),
        );
        dispatch(all({}));
    }, [dispatch]);
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        />
                                        <TableHeading
                                            label="Academic Calendar Event Type"
                                            col_name="academic_calendar_event_types_id"
                                            sort
                                        />
                                        <TableHeading
                                            label="Title"
