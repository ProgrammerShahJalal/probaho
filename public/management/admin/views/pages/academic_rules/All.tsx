    ...
    useEffect(() => {
        ...
        dispatch(
            storeSlice.actions.set_select_fields(
                'id,branch_user_id,branch_id,academic_year_id,academic_rules_types_id,title,description,date,file,status',
            ),
        );
        dispatch(all({}));
    }, [dispatch]);
    ...
    return (
        <div className="page_content">
            <div className="explore_window fixed_size">
                ...
                <Header title={'All Academic Rules'} />
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        />
                                        <TableHeading
                                            label="Academic Rules Type"
                                            col_name="academic_rules_types_id"
                                            sort
                                        />
                                        <TableHeading
                                            label="Title"
                                    ...
                                    {(state.all as any)?.data?.map(
                                        (i: { [key: string]: any }) => (
                                            ...
                                            >
                                                ...
                                                <td
                                                    {...getTruncatedCellProps({
                                                        text: i.academic_rules_types_id
                                                            ? formatArrayForTable(i.academic_rules_types, 'title')
                                                            : i.academic_rules_types_id,
                                                        columnType: 'title',
                                                        maxLength: 20,
                                                    })}
                                                />
