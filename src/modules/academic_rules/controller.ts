...
import import_academic_calendar_event_types from '../academic_calendar_event_types/services/import_academic_calendar_event_types';
import import_academic_rules_types from '../academic_rules_types/services/import_academic_rules_types';
...
export default function (fastify: FastifyInstance) {
    return {
        ...
        import_academic_rules: async function (req: FastifyRequest, res: FastifyReply) {
                    try {
                        ...
                        let data: responseObject = await import_academic_rules_types(fastify, req);
                        return res.code(data.status).send(data);
                    } catch (error: any) {
                        return handleServiceError(error, res);
                    }
