...
export default async function import_academic_rules_types(
    ...
    try {
                ...
                complete: async (results) => {
                    ...
                    for (const [index, row] of results.data.entries()) {
                        ...
                        try {
                            ...
                            await models.AcademicRulesTypesModel.create({
        ...
        console.error('Error in import_academic_rules_types service:', error);
        // This catches errors from Papa.parse if it rejects, or other synchronous errors
        return {
            status: error.status || 500,
            message: error.message || 'An unexpected error occurred during academic rules types import.',
