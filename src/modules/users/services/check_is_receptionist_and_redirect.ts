...
const check_is_receptionist_and_redirect = async (
    ...
    if (!token || !token.startsWith('Bearer ')) {
        return reply.redirect(`/receptionist-login`);
    }
    ...
    try {
        ...
        // Check if the user is an receptionist
...
export default check_is_receptionist_and_redirect;
