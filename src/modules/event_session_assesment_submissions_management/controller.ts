...
import userBasedFindingService from './services/userbasedfinding';
...
export default function (fastify: FastifyInstance) {
    ...
    return {
        ...
        findbyEventSessionAssessmentUser: async (req: FastifyRequest, res: FastifyReply) => handle(userBasedFindingService)(req, res),
