...
const tableName = 'branch_class_buildings';
const modelName = 'BranchClassBuildingsModel';
...
class DataModel extends Model<Infer, InferCreation> {
    ...
    declare image?: string; // Optional image field
    ...
    DataModel.init(
        {
            ...
            image: {
                type: DataTypes.STRING(255),
                allowNull: true, // Optional field for image
            },
            status: {
